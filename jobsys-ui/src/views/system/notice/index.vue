<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="noticeList" @selection-change="handleSelectionChange" :border="true">
      ...
      <el-table-column label="发布者" align="center" prop="createBy" width="180"/>
      <el-table-column label="发布时间" align="center" prop="createTime" width="250" sortable>
        <template slot-scope="scope">
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getNotice(noticeId).then(response => {
        ...
        this.open = true;
        this.title = "修改公告："+ row.noticeTitle;
      });
    },
    /** 提交按钮 */
    submitForm: function () {
