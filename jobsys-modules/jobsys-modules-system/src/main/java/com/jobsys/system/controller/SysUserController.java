...
import com.jobsys.system.service.*;
...
public class SysUserController extends BaseController {
     ...
     *
     * @param user 用户信息
     * @return com.jobsys.common.core.web.page.TableDataInfo
     * @author PengFei Deng
     ...
     * @return com.jobsys.common.core.domain.R<java.lang.Boolean>
     * @author PengFei Deng
    ...
    public R<Boolean> register(@RequestBody SysUser sysUser) {
        ...
        if (UserConstants.NOT_UNIQUE.equals(userService.checkUserNameUnique(username))) {
            return R.fail("注册失败，用户名：" + username + " 已存在！");
        }
        Boolean res = userService.registerUser(sysUser);
        return R.ok(res);
    }
