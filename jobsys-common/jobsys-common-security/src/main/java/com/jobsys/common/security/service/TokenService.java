package com.jobsys.common.security.service;
...
public class TokenService {
    ...
    public Map<String, Object> createToken(LoginUser loginUser) {
        ...
        Long comId = loginUser.getSysUser().getComId();
        ...
        claimsMap.put(SecurityConstants.DETAILS_COM_ID, comId);
